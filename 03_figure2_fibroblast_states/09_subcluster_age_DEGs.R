# =============================================================================
# 09_subcluster_age_DEGs.R
# Title : Age DEGs within each subtype
# Figure: Fig. 2E
# Module: 03_figure2_fibroblast_states
# Description:
#   Aged-vs-young FindMarkers within every subtype across species; up/down DEG tables and heat maps.
# Inputs:
#   - (see script)
# Outputs:
#   - hu("res", "Myeloid_human_diff_list.pdf")
...
Myeloid_species_final <- subset(Myeloid_species_rpca_sub_label,
                           subtype%in%c( 'Timd4_resident_MC',
                                         'MHClow_MC',
                                         'CCR2_MC',
                                         'MHChi_MC',
                                         'Mono',
...
pdf(hu("res", "Myeloid_human_diff_list.pdf"),width = 12,height = 12)
jjVolcano(diffData = Myeloid_human_diff,
          log2FC.cutoff = 1,
          topGeneN =5,
