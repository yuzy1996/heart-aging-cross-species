# =============================================================================
# 15_celltype_conserved_markers.R
# Title : Conserved cell-type markers across species
# Figure: Fig. 1B; Supplementary
# Module: 02_figure1_cross_species_atlas
# Description:
#   FindAllMarkers per species and intersect conserved cell-type markers (Venn/heat map).
# Inputs:
...
names(celltypes_venn) <- celltypes
